...
void exibe_dados_autor() {
	...
	printf("---------------------------------\n");
	printf("Nome: Gabrielle Vitória da Silva\n");
	printf("R.A.: 121 048 221 2 028\n");
	printf("---------------------------------\n");
...
int grava_arquivo_binario ( ) {
	...
	// gravação dos valores das variáveis
	fwrite( &cli, sizeof(cli), 1, arquivo);
